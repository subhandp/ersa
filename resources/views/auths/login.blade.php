...
<body>
    <div class="kotak_login">
        ...
        @endif
        <img src="/general/kemenag-logo.png" alt="Logo" class="logo">
        <br>
        <h2 class="font-weight-bold text-center">Aplikasi</h2>
        <h2 class="font-weight-bold text-center">Manajemen Surat</h2>
        <h2 class="font-weight-bold text-center">Bimas Hindu Sulteng</h2>


        <form action="postlogin" method="POST">
            @csrf
            <input name="username" class="form_login" placeholder="username" required>
